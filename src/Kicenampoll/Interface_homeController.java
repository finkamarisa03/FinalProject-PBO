...
public class Interface_homeController implements Initializable {
    ...
    @FXML
    private void changePane_Login(ActionEvent event) throws IOException {
        AnchorPane pane = FXMLLoader.load(getClass().getResource("/view/Interface_Login.fxml"));
        pane_home.getChildren().setAll(pane);
    }

    @FXML
    private void changePane_SignUp(ActionEvent event) throws IOException {
        AnchorPane pane = FXMLLoader.load(getClass().getResource("/view/Interface_SignUp.fxml"));
        pane_home.getChildren().setAll(pane);
    }
